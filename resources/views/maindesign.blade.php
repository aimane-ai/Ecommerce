        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="user_option">
            ...
            <a href="{{route('cardproduct')}}">
              <i class="fa fa-shopping-bag" aria-hidden="true"><span class="text text-danger">{{$count}}</span></i>
            </a>
      ...
      <div class="row">
        <div class="col-lg-7 col-md-6 px-0">
          <div class="map_container">
            ...
            <iframe 
                src="https://www.google.com/maps/embed/v1/place?key={{env('GOOGLE_MAPS_API_KEY')}}&q=Safi+Morocco" 
                width="600" 
                height="300" 
                frameborder="0" 
